...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casa-do-livro$1.0.0/src/app/views/Livros/Form/Form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"coloque o titulo\" value=\"" +
    ...
    "\"></div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" value=\"" +
...
marko_template.meta = {
    id: "/casa-do-livro$1.0.0/src/app/views/Livros/Form/Form.marko",
    tags: [
